...
public partial class @PlayerActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""SheildSpawner"",
            ""id"": ""ba39e9d0-3df6-4224-a727-83c5e3eb7179"",
            ""actions"": [
                {
                    ""name"": ""SpawnShield"",
                    ""type"": ""Button"",
                    ""id"": ""9a59a7b5-7e26-47fc-9c26-202c667356e3"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""903a12ba-bf58-45ac-88b1-bccb848ced6e"",
                    ""path"": ""<Keyboard>/t"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // SheildSpawner
        m_SheildSpawner = asset.FindActionMap("SheildSpawner", throwIfNotFound: true);
        m_SheildSpawner_SpawnShield = m_SheildSpawner.FindAction("SpawnShield", throwIfNotFound: true);
    }
    ...
    // SheildSpawner
    private readonly InputActionMap m_SheildSpawner;
    private List<ISheildSpawnerActions> m_SheildSpawnerActionsCallbackInterfaces = new List<ISheildSpawnerActions>();
    private readonly InputAction m_SheildSpawner_SpawnShield;
    public struct SheildSpawnerActions
    {
        private @PlayerActions m_Wrapper;
        public SheildSpawnerActions(@PlayerActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @SpawnShield => m_Wrapper.m_SheildSpawner_SpawnShield;
        public InputActionMap Get() { return m_Wrapper.m_SheildSpawner; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(SheildSpawnerActions set) { return set.Get(); }
        public void AddCallbacks(ISheildSpawnerActions instance)
        {
            if (instance == null || m_Wrapper.m_SheildSpawnerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SheildSpawnerActionsCallbackInterfaces.Add(instance);
            @SpawnShield.started += instance.OnSpawnShield;
            @SpawnShield.performed += instance.OnSpawnShield;
            @SpawnShield.canceled += instance.OnSpawnShield;
        }

        private void UnregisterCallbacks(ISheildSpawnerActions instance)
        {
            @SpawnShield.started -= instance.OnSpawnShield;
            @SpawnShield.performed -= instance.OnSpawnShield;
            @SpawnShield.canceled -= instance.OnSpawnShield;
        ...
        public void RemoveCallbacks(ISheildSpawnerActions instance)
        {
            if (m_Wrapper.m_SheildSpawnerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ISheildSpawnerActions instance)
        {
            foreach (var item in m_Wrapper.m_SheildSpawnerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SheildSpawnerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public SheildSpawnerActions @SheildSpawner => new SheildSpawnerActions(this);
    ...
    public interface ISheildSpawnerActions
    {
        void OnSpawnShield(InputAction.CallbackContext context);
    }
}
